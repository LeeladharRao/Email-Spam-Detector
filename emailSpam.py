...
#loading the dataset 0007.1999-12-14.farmer.ham.txt
...
#loading sample spam 0058.2003-12-21.GP.spam.txt
...
emails_test = [
    ...
    paragraph ( a ) ( 2 ) ( c ) of s . 1618 . further transmission to you by the sender of 
    this e-mail may be stopped at no cost to you by sending a reply to : " email address " 
...
#split the training the testing size as 67% and 33%, respectively. 
...
#loading the naive bayes algorithm
